...
function addTeam(team, isFirstChild) {
    ...
    const teamRowTemlate = `
        ...
        <td>
            ...
            <input id="inputTag${team.id}" class="team-logo--input" type="file" accept="image/*" />
        </td>
    ...
    teamRowElem.classList.add("team-row")
    // teamRowElem.classList.add("team-row__edit")
    ...
    updateBtnElm.addEventListener("click", async () => {
        ...
        teamRowElem.classList.remove("team-row__edit")
    })
